...
trainer = TrainerModule(X_train,Y_train,X_test,Y_test,X_vali,Y_vali,meanX,stdX,meanY,stdY,
                        ...
                        optimizer_hparams=[hparams['max_grad_norm_tune'], hparams['lr_tune'], hparams['decay_tune']],
                        loss_str=hparams['loss_str'],
                        loss_weights=[hparams['l2_tune'],hparams['c_loss_tune'],hparams['percent_loss_tune']],
                        like_dict=like_dict,
                        init_rng=42,

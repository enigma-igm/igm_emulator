...
if small_bin_bool == True:
    train_num = '_train_100_bin59_seed_42' #'_training_768_bin59' #'_train_100_bin59_seed_42' #'_train_30_bin59_seed_22'   #'_train_300_bin59_seed_66'
    test_num = '_test_80_bin59_seed_42' #'_test_89_bin59' #'_test_80_bin59_seed_42' #'_test_80_bin59_seed_22'  #_test_80_bin59_seed_66'
    vali_num = '_vali_320_bin59_seed_42' #'_vali_358_bin59' #'_vali_320_bin59_seed_42' #'_vali_320_bin59_seed_22' #'_vali_320_bin59_seed_66'
    n_path = 20  # 17->20
    n_covar = 500000
...
if __name__ == '__main__':
    def objective(trial):
        layer_sizes_tune = trial.suggest_categorical('layer_sizes', [[100, 100, 100, 100, 59], [8, 16, 16, 32, 59], [100, 100, 100, 59], [8, 16, 32, 59]]) # at least three hidden layers

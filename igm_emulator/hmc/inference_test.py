    ...
    for mock_idx in pbar(range(n_inference)):
        ...
        if mock_idx < 10:
            corner_fig = corner.corner(np.array(theta_samples), levels=(0.68, 0.95), labels=var_label,
                                       ...
                                       quantiles=(0.16, 0.5, 0.84),title_kwargs={"fontsize": 15}, label_kwargs={'fontsize': 12},
            ...
            if true_log_prob_on_prior:
                ...
                corner_fig.savefig(
                    out_path_plot + f'corner_T{closest_temp_idx}_G{closest_gamma_idx}_SNR{noise_idx}_F{closest_fobs_idx}_P{n_path}{bin_label}_mock_{mock_idx}_{var_tag}_{note}_ngp.png')

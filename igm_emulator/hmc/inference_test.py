...
hmc_infer = INFERENCE_TEST(redshift=5.4,gaussian_bool=True,ngp_bool=False,emu_test_bool=False,nn_err_prop_bool=False, n_inference=100)#,key_sample=42,key_hmc=66)

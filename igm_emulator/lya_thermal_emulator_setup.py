...
def  get_emulator_setups():
    ...
    small_scale = input("Less velocity bins of Ly-a forest (Y/N): ") == 'Y' or 'y'
...
if __name__ == "__main__":
    ...
    emulator_tune = input('Optimize hyperparameters of a NN emulator in ~10 min (Y/N)?') == 'Y' or 'y'
    ...
    emulator_train = input('Show training of a best-hparam emulator with plots in ~5 sec (Y/N)?') == 'Y' or 'y'
    if emulator_train:
